...
export function Portfolio() {
    ...
    <title>Divyum - Portfolio</title>
       ...
       <Col md="6">
         ...
         <hr></hr>
        <Timeline>
        <Event interval={"Feb 2020 - Present"} title={"Icecap Loan Underwriting"} subtitle={"Icecap Group, New York"}>
      ...
      • Web app for scanning the Technology Stack and Security Check for websites.<br></br>
      • Technologies used: React, Redux, JavaScript, HTML, CSS.
      </Event>
      <Event interval={"September 2019 - November 2019"} title={<a href="https://careers.xenonstack.com/" target="_blank">XenonStack Careers</a>} subtitle={"XenonStack, Chandigarh"}>
      • Worked on adding new features in Content Management System for Admin & User Portal, Integrated API Endpoints.<br></br>
      • Technologies used: React, Redux, JavaScript, HTML, CSS.
      </Event>
    </Timeline>
    <Footer/>
